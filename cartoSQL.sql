...
update workorders set census_block = nycb2010.bctcb2010 from nycb2010 where st_intersects(workorder.the_geom,nycb2010.the_geom);
update workorders set census_tract = nyct2010.ct2010 from nyct2010 where st_intersects(workorder.the_geom,nyct2010.the_geom);		